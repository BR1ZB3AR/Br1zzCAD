...
export const I18N_KEYS = [
    ...
    "body.circle",
    "body.cone",
    "body.constraint.coincident",
    "body.constraint.distance",
    "body.constraint.equal",
    "body.constraint.fixed",
    "body.constraint.horizontal",
    "body.constraint.parallel",
    "body.constraint.perpendicular",
    "body.constraint.vertical",
    "body.cylinder",
    "body.editableShape",
    "body.ellipse",
    "body.ellipticalArc",
    ...
    "command.constraint.distance",
    "command.constraint.equal",
    "command.constraint.fixed",
    ...
    "command.create.box",
    "command.create.centerRect",
    "command.create.circle",
    "command.create.circle3Point",
    "command.create.circumscribedPolygon",
    "command.create.cone",
    "command.create.copyShape",
    "command.create.cylinder",
    "command.create.dimensionAngle",
    "command.create.dimensionAuto",
    ...
    "command.create.ellipticalArc",
    "command.create.extrude",
    "command.create.folder",
    "command.create.group",
    "command.create.helix",
    "command.create.line",
    "command.create.lineMidpoint",
    "command.create.loft",
    ...
    "command.modify.toggleConstruction",
    "command.modify.trim",
    "command.sketch.edit",
