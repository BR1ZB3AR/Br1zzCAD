...
export default {
    ...
    translation: {
        ...
        "command.workingPlane.alignToPlane": "Align to Face",
        "command.workingPlane.fromSection": "From Section",
        "command.workingPlane.set": "Set Plane",
        "command.workingPlane.toggleDynamic": "Dynamic Plane",
        ...
        "document.untitled{0}": "Document {0}",
        ...
        "home.recent.empty": "Start a new document or open an existing one — it will show up here next time.",
        "home.recent.empty.title": "No recent projects yet",
        ...
        "home.welcome.subtitle": "Create sketches, solids, and assemblies — entirely in your browser.",
        "items.header": "Items",
        ...
        "properties.empty": "Select an item in the tree to edit its properties.",
        ...
        "toast.command.{0}excuting": "Command {0} is running",
