...
export default {
    ...
    translation: {
        ...
        "dialog.title.selectSketchPlane": "选择草图平面",
        ...
        "workingPlane.top": "顶视图",
        "workingPlane.front": "前视图",
        "workingPlane.right": "右视图",
        "toast.sketch.planeSet{0}": "草图平面：{0}",
        "statusBar.snap": "捕捉",
        ...
        "toast.sketch.selectPlane": "请先选择草图平面（顶/前/右）",
