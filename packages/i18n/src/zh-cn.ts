...
export default {
    ...
    translation: {
        ...
        "body.circle": "圆形",
        "body.cone": "圆锥",
        "body.constraint.coincident": "重合",
        "body.constraint.distance": "距离",
        "body.constraint.equal": "等长",
        "body.constraint.fixed": "固定",
        "body.constraint.horizontal": "水平",
        "body.constraint.parallel": "平行",
        "body.constraint.perpendicular": "垂直",
        "body.constraint.vertical": "竖直",
        "body.cylinder": "圆柱",
        "body.editableShape": "可编辑的形状",
        "body.ellipse": "椭圆",
        "body.ellipticalArc": "椭圆弧",
        "body.face": "面",
        "body.helix": "螺旋线",
        "body.fuse": "合并",
        "body.group": "组",
        ...
        "command.ai.assistant": "AI 助手",
        "command.boolean.common": "交集",
        "command.boolean.cut": "减去",
        "command.boolean.join": "合并",
        "command.constraint.coincident": "重合",
        "command.constraint.distance": "距离",
        "command.constraint.equal": "等长",
        "command.constraint.fixed": "固定",
        "command.constraint.horizontal": "水平",
        "command.constraint.parallel": "平行",
        "command.constraint.perpendicular": "垂直",
        "command.constraint.vertical": "竖直",
        ...
        "command.create.alignedRect": "对齐矩形",
        ...
        "command.create.centerRect": "中心矩形",
        "command.create.circle": "圆形",
        "command.create.circle3Point": "三点圆",
        "command.create.circumscribedPolygon": "外切多边形",
        "command.create.cone": "圆锥",
        "command.create.copyShape": "复制形状",
        "command.create.cylinder": "圆柱",
        "command.create.dimensionAngle": "角度标注",
        "command.create.dimensionAuto": "自动标注",
        ...
        "command.modify.toggleConstruction": "构造线",
        ...
        "prompt.select.sketchPlane": "点击顶面、前面、右面或任意表面以在其上绘制草图，按ESC键取消",
        ...
        "toast.constraint.unsolvable": "无法在满足现有约束的同时满足此约束",
